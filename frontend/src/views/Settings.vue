          ...
          <li v-for="plugin in repoPlugins" :key="plugin.id" class="bg-gray-700 p-4 rounded-lg border border-gray-600 flex justify-between items-center">
            ...
            <div class="ml-4 flex-shrink-0 flex items-center space-x-2">
              <template v-if="plugin.is_installed">
                ...
                <button v-else @click="installPlugin(plugin)" :disabled="installingPluginId === plugin.id" class="bg-yellow-600 hover:bg-yellow-500 disabled:opacity-50 disabled:cursor-not-allowed text-white py-2 px-4 rounded-lg shadow-md transition-all font-medium text-sm flex items-center space-x-2">
                  <svg v-if="installingPluginId === plugin.id" class="animate-spin h-4 w-4 text-white" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                  <span>{{ installingPluginId === plugin.id ? 'Updating...' : 'Update' }}</span>
                </button>
              ...
              <button v-else @click="installPlugin(plugin)" :disabled="installingPluginId === plugin.id" class="bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed text-white py-2 px-4 rounded-lg shadow-md transition-all font-medium text-sm flex items-center space-x-2">
                <svg v-if="installingPluginId === plugin.id" class="animate-spin h-4 w-4 text-white" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                <span>{{ installingPluginId === plugin.id ? 'Installing...' : 'Install' }}</span>
              </button>
            </div>
          </li>
        </ul>
...
const installingPluginId = ref(null)
